...
export default function MyAccount(){
    ...
    // const fname=userData?.userData.fname.toUpperCase();
    // const lname=userData?.userData.lname.toUpperCase();
                ...
                <div>
                    <div>
                        <div className={styles.nameLog}>
                            {isAuth?<h1>{userData.fname.toUpperCase()[0]+userData.lname.toUpperCase()[0]}</h1>:null}
                        </div>
                        <span>Hi,</span>
                        {isAuth?<h3>{userData.fname.toUpperCase()+userData.lname.toUpperCase()}</h3>:null}
                    </div>
                    <div>
